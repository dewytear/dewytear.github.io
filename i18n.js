...
var STRINGS = {
    ko: {
        ...
        cosmosSub3d2: '궤도계 — World가 항성, System이 행성, 문서가 위성으로 공전합니다 · 드래그 회전 · 휠 확대 · 문서 클릭 시 이웃 보기',
        cosmosSub3d3: '계층 스트라타 — World→Domain→System→Document 네 층 · 드래그 회전 · 휠 확대 · 문서 클릭 시 이웃 보기',
        c2Open: '문서 열기', c2Close: '닫기', c2Refs: '피참조', c2Nbr: '이웃',
        gvView3d: '성좌', gvView3d2: '궤도계', gvView3d3: '스트라타',
