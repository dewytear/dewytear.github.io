...
var STRINGS = {
    ko: {
        ...
        visitsToday: '오늘', visitsTotal: '전체',
        visitsTitle: '방문자 수 — 오늘 / 전체 (쿠키 없는 집계, 최대 4시간 지연)',
        docViews: '조회:',
    ...
    en: {
        ...
        visitsToday: 'Today', visitsTotal: 'Total',
        visitsTitle: 'Visitors — today / all time (cookieless, up to 4h behind)',
        docViews: 'Views:',
