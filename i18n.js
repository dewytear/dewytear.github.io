...
var STRINGS = {
    ko: {
        ...
        mkLegend1: '더블클릭 = 노드 · 가장자리 드래그 = 관계 · 같은 노드로 = 루프',
        mkLegend2: '드래그로 배치(핀 고정) · Delete = 삭제 · Ctrl+Z = 되돌리기',
        mkLabelPh: '라벨 입력 후 Enter',
        mkRename: '이름', mkLink: '연결', mkDelete: '삭제',
        mkProps: '속성', mkPropKey: '키', mkPropVal: '값',
        mkPropAdd: '+ 속성 추가', mkPropDone: '완료',
        mkPropTags: '태그', mkEdgeNamePh: '이름 (선택)',
        ...
        fMusic: '배경음악 (YouTube 재생목록 또는 영상 링크·ID)',
        phMusic: '예: youtu.be/… 또는 재생목록 링크 · 비우면 사이트 기본 음악을 따릅니다',
        fLang: '언어 (Language)',
        ...
        fThemeFx: '테마 전환 효과',
        optFxInk: '먹 번짐', optFxOff: '즉시 전환',
        fThemeFxMs: '번짐 길이 (초)',
        fThemeFxMsHint: '낮/밤 스위치를 눌렀을 때 먹이 번져 화면이 바뀌는 시간. 0.4~1.4초 사이. 모션 최소화를 켠 브라우저에서는 이 값과 무관하게 즉시 전환됩니다.',
        themeFxBothL: '양방향 — 밤→낮, 낮→밤 모두 번지게',
    ...
    en: {
        ...
        mkLegend1: 'Double-click = node · drag from rim = relation · back to same node = loop',
        ...
        mkProps: 'Properties', mkPropKey: 'Key', mkPropVal: 'Value',
        mkPropAdd: '+ Add property', mkPropDone: 'Done',
        mkPropTags: 'Tags', mkEdgeNamePh: 'Name (optional)',
        ...
        searchPartial: 'No page contains every word, so these match only some of them.',
        searchMore: '+{n} more…',
        ...
        fMusic: 'Background music (YouTube playlist, or a video link/id)',
        phMusic: 'e.g. youtu.be/… or a playlist link · empty = follow the site track',
        fLang: 'Language',
        ...
        fThemeFx: 'Theme transition',
        optFxInk: 'Ink bleed', optFxOff: 'Instant',
        fThemeFxMs: 'Bleed duration (seconds)',
        fThemeFxMsHint: 'How long the ink takes to spread across the screen when you flip the day/night switch, between 0.4 and 1.4 seconds. Browsers with reduced motion turned on always switch instantly, whatever this says.',
        themeFxBothL: 'Both ways \u2014 bleed going dark\u2192light and light\u2192dark',
    ...
    ja: {
        ...
        mkLegend1: 'ダブルクリック＝ノード · 縁からドラッグ＝関係 · 同じノードへ＝ループ',
        mkLegend2: 'ドラッグで配置（ピン固定）· Delete＝削除 · Ctrl+Z＝元に戻す',
        mkLabelPh: 'ラベルを入力してEnter',
        mkRename: '名前', mkLink: 'リンク', mkDelete: '削除',
        mkProps: '属性', mkPropKey: 'キー', mkPropVal: '値',
        mkPropAdd: '+ 属性を追加', mkPropDone: '完了',
        mkPropTags: 'タグ', mkEdgeNamePh: '名前（任意）',
        ...
        fMusic: 'BGM（YouTube プレイリスト、または動画のリンク・ID）',
        phMusic: '例: youtu.be/… またはプレイリストのリンク · 空ならサイト既定の音楽に従います',
        fLang: '言語 (Language)',
        ...
        fThemeFx: 'テーマ切り替えの効果',
        optFxInk: '墨のにじみ', optFxOff: '即時切り替え',
        fThemeFxMs: 'にじみの長さ（秒）',
        fThemeFxMsHint: '昼夜スイッチを押したとき、墨がにじんで画面が変わるまでの時間。0.4〜1.4秒。モーション軽減を有効にしたブラウザではこの値に関係なく即時に切り替わります。',
        themeFxBothL: '双方向 — 夜→昼、昼→夜のどちらもにじませる',
